...
WARNING: You now have 10 minutes to connect to the RStudio Server and start the
R session before everything times out.
```
...
```sh
$ cd /path/to/software
$ curl -L -O https://github.com/UCSF-CBI/rstudio-server-controller/archive/refs/tags/0.8.1.tar.gz
$ tar xf 0.8.1.tar.gz
$ PATH=/path/to/softwarerstudio-server-controller-0.8.1/bin:$PATH
$ export PATH
$ rsc --version
0.8.1
```
