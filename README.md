...
```sh
$ cd /path/to/software
$ curl -L -O https://github.com/UCSF-CBI/rstudio-server-controller/archive/refs/tags/0.20.0.tar.gz
$ tar xf 0.20.0.tar.gz
$ PATH=/path/to/softwarerstudio-server-controller-0.20.0/bin:$PATH
$ export PATH
$ rsc --version
0.20.0
```
